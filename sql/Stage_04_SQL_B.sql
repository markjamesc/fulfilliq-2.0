...
-- Frozen-snapshot identity locked to shared Stage 4 freeze values.
SET @specification_id       = 'fulfilliq-2.0-stage3-candidate-v0.2.1';
SET @snapshot_id            = 'fulfilliq-olist-frozen-2026-09-08';
SET @source_version         = 'olist-csv-raw_tables';
